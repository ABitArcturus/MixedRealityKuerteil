...
/**
 * Adds a-frame control elements to the scene: sinewave selection, frequency adjust, 
...
export function addAFrameElements() {
       ...
       for (let i = 0; i < totalNumberOfKeys; i++) {
              ...
              sinewaveBox.setAttribute('osc-index', i);
              ...
              squareBox.appendChild(squareText);
              ...
              sawtoothBox.appendChild(sawtoothText);
              ...
              triangleBox.appendChild(triangleText);
              ...
              freqAdjust.setAttribute('osc-index', i);
              ...
              potentiometer.setAttribute('osc-index', i);
